...
def build_and_deploy():
    print("🚀 开始编译发布 v19.1 极速流畅静音版（0% 空闲 CPU · 丝滑光标）...")
    
    release_dir = r"C:\v19_release"
    ...
    dist_exe = os.path.join(release_dir, "dist", "DualLayerPDF_v19_Pro.exe")
